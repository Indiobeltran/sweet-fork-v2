...
export function PublicPageHero({
  ...
  return (
    <section className="relative overflow-hidden border-b border-charcoal/8 bg-paper">
      ...
      <div className="mx-auto grid max-w-7xl gap-8 px-5 py-10 sm:px-8 sm:py-12 md:py-18 lg:grid-cols-[1.08fr_0.92fr] lg:items-end lg:gap-16 lg:py-20">
        <div className="space-y-6 section-reveal">
          <Badge>{eyebrow}</Badge>
          <div className="space-y-5">
            <h1 className="max-w-4xl text-balance font-serif text-4xl leading-[0.98] tracking-[-0.035em] text-charcoal sm:text-5xl lg:text-7xl lg:tracking-[-0.05em]">
              {title}
            </h1>
