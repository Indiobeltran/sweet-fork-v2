      ...
      {isOpen ? (
        <>
          ...
          <div
            ...
            className="absolute right-0 top-[calc(100%+0.7rem)] z-[70] w-[18.5rem] max-w-[calc(100vw-1.5rem)] rounded-[1.6rem] border border-charcoal/10 bg-white p-4 shadow-[0_24px_64px_rgba(53,37,29,0.14),0_8px_20px_rgba(53,37,29,0.08)] backdrop-blur-xl"
          >
